...
3. 进入 Package 页面，点击 repo 进入 Package 的 GitHub 主页，点击 `Versions` 查看最新的 release 版本
 ![点击Versions](/images/solution-for-install-atom-package-in-china/0Mzldh2bL9f2pJwQlEdUBkFSPb7KJLsR.jpg)
 
4. 下载 zip 格式的源码
 ![下载zip源码](/images/solution-for-install-atom-package-in-china/mXLOVdinwZJVDYaTDR9F6TRNPyHYTvHB.jpg)

5. 下载并且解压后，移动至 `无版本号Package文件夹`，例如：下载的 zip 文件为 `linter-2.2.0.zip`，移动到 `linter` 的文件夹
 ![文件夹结构](/images/solution-for-install-atom-package-in-china/M65e8T3Ex4LfznGyIhLmQYiyn7CVq6qB.jpg)

## 安装 Package

1. 查看 Atom 的 Packages 目录，在 Atom 的 `Preferences` 的 `Install` 标签可以看到 Atom 的 `Packages目录`
 ![查看Packages目录](/images/solution-for-install-atom-package-in-china/PTklV3Vx4aXvxyNyAb4ZIS8hotRMOupr.jpg)
