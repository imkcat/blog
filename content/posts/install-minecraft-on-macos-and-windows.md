...
author: "Kcat"
date: "2017-05-28 18:27"
readTime: "4 min read"
tags: ["Minecraft", "HMCL", "Windows", "macOS"]
---
...
![下载对应版本](/images/install-minecraft-on-macos-and-windows/JUz7Q08CSf0SgNTUiG3y8BSBBvqZbk8u.jpg)
...
2. 点击 `游戏下载`，选择你想要下载的 Minecraft 版本，再点击 `下载` 即可下载 Minecraft
 ![下载Minecraft](/images/install-minecraft-on-macos-and-windows/xoNwfQyhQLEKrGn35SfGtNdP5suYbXPo.jpg)
3. 等待游戏下载完成
4. 点击 `主页` 进入 HMCL 主页，选择下载好的 Minecraft 版本
5. 填写你想要的游戏玩家名称，点击 `启动Minecraft` 可进入 Minecraft
 ![启动Minecraft](/images/install-minecraft-on-macos-and-windows/sO8rGkvEO3OZQvx1JG4r7O6cqjeUZo6Q.jpg)
